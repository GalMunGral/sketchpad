var _a;
const __DEBUG__ = !!((_a = new URLSearchParams(location === null || location === void 0 ? void 0 : location.search)) === null || _a === void 0 ? void 0 : _a.get("visualize"));
...
function fillRect(x, y, width, height) {
    ctx.fillRect(x * __SCALE__, y * __SCALE__, width * __SCALE__, height * __SCALE__);
}
ctx.fillStyle = "black";
fillRect(0, 0, ROW_SIZE, COL_SIZE);
export function writeToFrameBuffer(addr, data) {
